...
| Institution | Published report | Result |
| --- | ---: | --- |
| CertiK | 42-page PDF | Pass |
| SlowMist | 27-page PDF | Pass |
| OpenZeppelin | 37-page PDF | Pass |

The customer-facing publication contains exactly three complete PDFs. All 106
published PDF pages were rendered and inspected. No blank page,
...
- The controlled source package was separately checked for editable DOCX/PDF semantic parity and WPS pagination before the public set was reduced to complete PDFs.
...
- The three published PDF hashes are recorded in
